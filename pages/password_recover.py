from locators.password_recover_locators import PasswordRecoverLocators
...
class PasswordRecoverPage(Page):
    ...
    def click_link_to_recover_password_page(self):
        super().click_on_element_with_javascript(self.password_recover_locators.link_to_page)
    ...
    def click_recover_password_button(self):
        super().click_on_element_with_javascript(self.password_recover_locators.recover_button)
    ...
    def check_second_recover_stage_is_loaded(self):
        return super().check_page_load(self.password_recover_locators.verification_code_input)
    
    def click_show_hide_button(self):
        super().click_on_element_with_javascript(self.password_recover_locators.show_hide_button)
        
    def check_password_field_in_focus(self):
        return super().check_page_load(self.password_recover_locators.password_field_in_focus)