...
class OrderFeedLocators:
    ...
    complete_all_time = [By.XPATH, "//p[contains(text(), 'Выполнено за все время:')]//following::p[1]"]
    complete_today = [By.XPATH, "//p[contains(text(), 'Выполнено за сегодня:')]//following::p[1]"]
    today_in_work = [By.XPATH, "//ul[contains(@class, 'OrderFeed_orderListReady')]//descendant::li[1]"]