...
class CreateOrderLocators:
    ...
    fluorescent_bread_ingredient = [
        By.XPATH,
        "//p[contains(text(), 'Флюоресцентная булка R2-D3')]//ancestor::a[contains(@class, 'BurgerIngredient_ingredient__1TVf6')]",
    ]
    fluorescent_bread_ingredient_title = [
        By.XPATH,
        "//div[contains(@class, 'undefined')]//following::p[contains(text(), 'Флюоресцентная булка R2-D3')]",
    ]
    ingredient_close_button = [By.CSS_SELECTOR, ".Modal_modal_opened__3ISw4 button"]
    order_drop_field = [
        By.XPATH,
    ...
    fluorescent_bread_ingredient_counter = [
        By.XPATH,
        "//a[contains(@href, '/ingredient/61c0c5a71d1f82001bdaaa6d')]//ancestor::p[contains(@class, 'counter_counter__num__3nue1')]",
    ]
